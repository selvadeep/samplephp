      ...
      <ul class="side-menu-list">
       ...
       <li class="black">
             ...
             <li class="black opened">
              <a href="doctor.php">
                 <i class="fa fa-user-md active" aria-hidden="true"></i>
  ...
  <body class="dataTables">
    ...
    <select id="location2" name="select" class="form-control">
      <option value="" >Select the Location</option>
       <?php
include "config.php";
$result = mysqli_query($link, "SELECT  DISTINCT location FROM doctor");
...
?>
      ...
      <table id="cableconnect" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            ...
            <th>Doctor name</th>
            <th>Doctor email</th>
            <th>Doctor Mobnumber</th>
            <th>Doctor hospital(working)</th>
            <th>Area</th>
            <th>City</th>
            <th>State</th>
            <th>Country</th> 
...
<form id="form1">
  ...
  <div class="form-group">
    <label for="customerHospital">hospital</label>
    <input type="text" class="form-control" id="hospital1">
  </div> 
  <div class="form-group">
    <label for="Name">Area</label>
...
debugger;
  ...
  var location=$('#location1').val();
      ...
      var datas1={'id1': id,'name1': name, 'mobnumber': mobnumber ,'email':email,'location':location,'hospital':hospital}
...
function getIndex()
{
    ...
    var test = table.rows('.selected').data();
            ...
            $('#hospital').val(test[0][4]);
            $('#location').val(test[0][5]);
